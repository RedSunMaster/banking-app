...
@Composable
internal fun rememberChartStyle(columnChartColors: List<Color>, lineChartColors: List<Color>, state: DatabaseInformation): ChartStyle {
    val isSystemInDarkTheme = state.darkModeToggle
...
@Composable
internal fun rememberChartStyle(chartColors: List<Color>, state: DatabaseInformation) =
    rememberChartStyle(columnChartColors = chartColors, lineChartColors = chartColors, state)